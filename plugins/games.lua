--[[
الالعاب ل سورس ماكس
تم تعديل الملف واضافه الالعاب من قبل الشيخ الالم انا (@ali1b)
--]]
...
return "** هذا الامر يخص {المطور,المالك} فقط  \n" 
end 
...
name = string.gsub(name,'المخده',' انا خفيفه و انا لطيفه اكوم من حضن الوزير اكعد بحضن الخليفه أزيح الهموم  واخلي لحبيب نايم  مين انني')
...
~ 
امثله، لعبه امثله قديمة
مع انا، لعبه مع انا لسمايلات 
...
if msg.text == redis:get(max..':Set_Name_Meant:'..msg.chat_id_) then --// المع انا
redis:incrby(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
